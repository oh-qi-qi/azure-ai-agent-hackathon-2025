...
# Database tools for schedule management
class EquipmentSchedulePlugin:
    ...
    def get_schedule_comparison_data(self, equipment_code: str = None, project_code: str = None) -> str:
        ...
        try:
            ...
            params = []
            if equipment_code or project_code:
                query += " @EquipmentCode = ?, @ProjectCode = ?"
                params.append(equipment_code if equipment_code else None)
                params.append(project_code if project_code else None)
